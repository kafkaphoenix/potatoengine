...
bool EntityFactory::containsPrototypes(std::string_view prefabID) const { return m_prefabs.contains(prefabID.data()); }
...
void EntityFactory::createPrototype(std::string_view prefabID, std::string_view prototypeID, Entity&& e) {
  ...
  ENGINE_ASSERT(not m_prefabs.at(prefabID.data()).contains(prototypeID.data()),
                "Prototype {} for prefab {} already exists", prototypeID, prefabID);
...
void EntityFactory::updatePrototype(std::string_view prefabID, std::string_view prototypeID, Entity&& e) {
  ENGINE_ASSERT(m_prefabs.contains(prefabID.data()), "Unknown prefab {}", prefabID);
  ENGINE_ASSERT(m_prefabs.at(prefabID.data()).contains(prototypeID.data()), "Unknown prototype {} for prefab {}",
                prototypeID, prefabID);
