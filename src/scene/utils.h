...
CShaderProgram& castCShaderProgram(void* other) { return *static_cast<CShaderProgram*>(other); }

CTransform& castCTransform(void* other) { return *static_cast<CTransform*>(other); }

CMaterial& castCMaterial(void* other) { return *static_cast<CMaterial*>(other); }

CTextureAtlas& castCTextureAtlas(void* other) { return *static_cast<CTextureAtlas*>(other); }
...
CRigidBody& castCRigidBody(void* other) { return *static_cast<CRigidBody*>(other); }

CCollider& castCCollider(void* other) { return *static_cast<CCollider*>(other); }

CCamera& castCCamera(void* other) { return *static_cast<CCamera*>(other); }

CDistanceFromCamera& castCDistanceFromCamera(void* other) { return *static_cast<CDistanceFromCamera*>(other); }

CActiveCamera& castCActiveCamera(void* other) { return *static_cast<CActiveCamera*>(other); }
...
CParticle& castCParticle(void* other) { return *static_cast<CParticle*>(other); }

CAnimation& castCAnimation(void* other) { return *static_cast<CAnimation*>(other); }

CText& castCText(void* other) { return *static_cast<CText*>(other); }

CAI& castCAI(void* other) { return *static_cast<CAI*>(other); }

CRelationship& castCRelationship(void* other) { return *static_cast<CRelationship*>(other); }
...
CChunkManager& castCChunkManager(void* other) { return *static_cast<CChunkManager*>(other); }
...
// TODO: fix this, they are here because in their components they would add an import to entity again and it would be a
// circular dependency as sceneManager already includes entity.h
template <> void engine::SceneManager::onComponentAdded(Entity& e, CTexture& c) {
  c.setDrawMode();
...
template <> void engine::SceneManager::onComponentAdded(Entity& e, CChunkManager& c) {
  c.setMeshType();
  c.setMeshAlgorithm();
