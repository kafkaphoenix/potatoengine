...
static constexpr const char TERRAIN_SCENE[] = "terrain_scene";
static constexpr const char TERRAIN_SCENE_PATH[] = "assets/scenes/terrain_scene.json";
...
static constexpr const float CLEAR_DEPTH = 1.0f;  // default value
static constexpr const char* DEFAULT_SCENE = TERRAIN_SCENE;
static constexpr const char* DEFAULT_SCENE_PATH = TERRAIN_SCENE_PATH;
