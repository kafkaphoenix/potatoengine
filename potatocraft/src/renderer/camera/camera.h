...
namespace potatoengine
{
	...
	public:
		...
		void setProjection(const glm::mat4& projection) { m_projection = projection; m_viewProjection = m_projection * m_view;}
        ...
        void setOrientation(const glm::quat& orientation) { m_orientation = orientation; recalculateView(); }
