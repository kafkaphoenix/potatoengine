...
void drawSettings(Settings& settings) { 
    ...
    if (not selectedSettingTabKey.empty()) {
        ...
        if (selectedSettingTabKey == "Window") {
            ...
            if (ImGui::BeginCombo("Cursor mode", settings.cursorMode == 0 ? "Normal" : settings.cursorMode == 1 ? "Hidden"
            ...
            if (ImGui::BeginCombo("Debug level", settings.debugLevel == 0 ? "Trace" : settings.debugLevel == 1 ? "Info"
