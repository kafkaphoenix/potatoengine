...
void drawMetrics(bool* show_tool_metrics, std::weak_ptr<engine::AssetsManager> am, std::weak_ptr<engine::Renderer> r, engine::SceneManager& sm) {
    if (not *show_tool_metrics) return;
