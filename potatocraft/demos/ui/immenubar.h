...
#include "demos/settings.h"  // linter
#include "demos/ui/imabout.h"
#include "demos/ui/imlogger.h"
#include "demos/ui/immetrics.h"
#include "potatoengine/engineAPI.h"

namespace demos {

void drawMenuBar(std::weak_ptr<engine::AssetsManager> am, std::weak_ptr<engine::Renderer> r, engine::SceneManager& sm, Settings& settings) {
