...
Los videojuegos, pese a su popularidad, presentan muchas incógnitas para una persona que desee iniciarse en la creación
de ellos, preguntas tales como:
\begin{itemize}
...
amigos se juntan para crear un videojuego. Esto junto a la facilidad de encontrar tutoriales, vídeos y cursos online
...
deberían fomentarse más alternativas y opciones de código abierto para que el ecosistema puede seguir creciendo de forma
sana.

Así mismo estos motores muchas veces vienen sobrecargados con funcionalidades que aumentan su complejidad e incrementan
el tiempo para entenderlos o no se ajustan a lo que necesitamos. Por suerte la información sobre crear un motor de juegos
con la expansión de internet se ha hecho cada vez más accesible, pero desperdigada en un sin fin de artículos, libros,
vídeos y tutoriales.
...
y desde cero, los pasos a realizar para crear un motor de juegos, así como ofrecer online el fruto de ello con demostraciones
para el uso del público general. De tal forma que los usuarios puedan usar el motor para el desarrollo de sus juegos, si
así lo desean, y encuentren un set completo de herramientas para ello.
...
\begin{enumerate}[label=\textbf{O\arabic*.}]
    ...
    \begin{enumerate}[label=\textbf{O4.\arabic*.}]
        \item Creación de diagramas y videos tutoriales explicando de forma sencilla cada parte del motor de juegos y su uso.
        \item Creación de diferentes casos de uso del motor y una plantilla ejemplo de juego usando el motor.
        \item Creación de diagramas y videos tutoriales explicando de forma sencilla la creación de un juego de plataforma
...
se organizaron las fases del proyecto usando la herramienta \textit{Trello}, y se establecieron fechas concretas para
...
así como la metodología que se seguirán en el mismo, el segundo capítulo tratará sobre los trabajos relacionados, estudio
del arte y tecnologías empleadas o librerías que han ayudado al desarrollo del motor, permitiéndonos tener una idea clara
...
componente del motor, decisiones tomadas y comparación entre posible soluciones implementadas en otros motores.

Por último se cierra el documento con las conclusiones del proyecto, reflexiones y líneas futuras de mejoras posibles
del motor de juegos.

El proyecto se completa con una lista de acrónimos, bibliografía y anexos profundizando partes teóricas del motor.