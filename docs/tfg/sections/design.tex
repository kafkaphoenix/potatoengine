...
Por último, \textit{OpenGL} usa el lenguaje \gls{glsl}, parecido a \textit{C}, para comunicarse con la \gls{gpu}. Esta lógica se define en ficheros denominados \textit{shaders}\cite{shaders-getting-started}.
