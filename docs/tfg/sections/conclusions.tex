...
La solución planteada abstrae la complejidad de las diversas partes de un motor de juegos, además de ofrecer un 
...
\begin{itemize}
    ...
    \item \textbf{Más plantillas}: Por ejemplo, se podría añadir otra plantilla demostrando un juego de tipo \gls{3d-es}. También
    podría expandirse la actual.
    ...
    \item \textbf{Mejorar debugger}: Añadir una utilidad para consultar el rendimiento de la aplicación permitiría a los usuarios
    encontrar los cuellos de botella en sus aplicaciones, facilitando la optimización de código y el uso eficiente de la memoria, la CPU y la GPU.
    ...
    \item \textbf{Serialización}: Actualmente no es posible guardar el estado de un juego, sería una mejora añadir esta opción
    así los usuarios podrían guardar el estado de la escena y sus entidades.
